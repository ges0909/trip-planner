...
- **MCP registration**: `.mcp.json` at project root
...
| **Tavily**           | `mcp/tavily/`          | Web search & LLM-oriented content extraction                        | [tavily.com](https://tavily.com)                           |
| **Web Scraper**      | `mcp/web-scraper/`     | Raw HTML, CSS-selector text extraction & link extraction            | Target websites (no API key)                               |
...
Set `"disabled": true/false` per server in `.mcp.json`.
