...
Additional outputs are defined in the type-specific output template (`skills/bike-planner/references/output-template.md`, `skills/road-planner/references/output-template.md`).
