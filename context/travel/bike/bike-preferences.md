...
Persönliche Präferenzen für Radtouren. Diese Datei ergänzt `trips/AGENTS.md` (universelle Regeln) und `skills/bike-planner/SKILL.md` (technische Workflow-Regeln).
